<template>
    <div>
        ...
        <el-table :data="doctorData" border>
            ...
            ></el-table-column>
            <el-table-column label="Operation" prop="dSection" width="180" fixed="right">
    ...
    methods: {
            ...
            request
                ...
                .then((res) => {
                    if (res.data.status !== 200)
                        return this.$message.error("Success");
        ...
        deleteArrange(arrangeId) {
            request
                ...
                .then((res) => {
                    if (res.data.status !== 200)
                        return this.$message.error("Not_exist");
                    this.$message.success("Delete_success！");
                    this.requestDoctors();
                });
        },
        //页面大小改变时触发
